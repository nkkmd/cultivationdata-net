...
4. インフレーションの影響:
   全てのシナリオにおいて、月次リターンからインフレ率を差し引くことで、実質リターンを計算します。これにより、インフレーションがポートフォリオ価値に与える影響を反映します。

5. 資産クラスのリターンとボラティリティの設定:
...
4. **シナリオのシミュレーション**:
   - 通常シナリオとストレスシナリオの両方をシミュレートします。
   - 各月について：
     a. ポートフォリオの月次リターンをシミュレートします（正規分布を使用）。
     b. インフレ率を差し引いて実質リターンを計算します。
     c. 新しいポートフォリオ価値を計算します。
     d. 必要に応じてリバランスを行います。

5. **ストレスシナリオの適用**:
   選択されたストレスシナリオに応じて、リターンとボラティリティを調整します。

6. **結果の集計とグラフ化**:
   - 各シナリオの年末ポートフォリオ価値を記録します。
   - 通常シナリオとストレスシナリオの結果をグラフ化します。
